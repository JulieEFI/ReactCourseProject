...
export const fetchTechnologies = createAsyncThunk( // two arguments: first - string identifier, second - payload creator payload function
    "GET_TECHNOLOGIES",
    async () => {
  ...
  export const getTechnologiesSelector = (state) => state.technologies.technologies;
